...
MIDGAME_PSQT = {
    chess.PAWN: MIDGAME_PAWN_TABLE,
    chess.KNIGHT: MIDGAME_KNIGHT_TABLE,
    chess.BISHOP: MIDGAME_BISHOP_TABLE,
    chess.ROOK: MIDGAME_ROOK_TABLE,
    chess.QUEEN: MIDGAME_QUEEN_TABLE,
    chess.KING: MIDGAME_KING_TABLE
}
